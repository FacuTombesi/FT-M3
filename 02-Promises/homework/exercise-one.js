...
function problemA () {
  ...
  promisifiedReadFile("poem-one/stanza-01.txt") // Usa la función ya creada para crear una promesa del txt
  .then(stanza => blue(stanza)) // Da la resolución para cuando se cumple la promesa
}
...
function problemF () {
  ...
  .finally(() => console.log("done")) // Devuelve algo cuando todo haya terminado, salga todo bien o salga todo mal
}
